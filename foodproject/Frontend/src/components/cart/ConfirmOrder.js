            ...
            <div className='row d-flex justify-content-between'>
                            ...
                            <Fragment key={item.id}>
                                ...
                                <div className='cart-item my-1' key={item.fooditem}>
                                    <div className='row'>
                                        ...
                                        <div className='col-5 col-lg-6'>{item.name}
                ...
                <div className='col-12 col-lg-3 my-5 cartt'>
                    <div id="order_summary">
                        ...
                        <hr></hr>
                        <button id="checkout_btn" className='btn btn-primary btn-block' onClick={processToPayment}>Proceed To Payment</button><br></br>
                    </div>
                </div>
